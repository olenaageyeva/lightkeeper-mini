...
export const Peers = () => {
    ...
    return <section className="flex flex-col items-start  divide-y divide-gray-600 m-4 p-4 srink-0 bg-slate-50 shadow rounded-md dark:bg-gray-900 dark:text-slate-100">
